...
PUBLIC_MARKDOWN = [
    ...
    Path("docs/operations-install.md"),
    Path("docs/operations-preflight.md"),
    Path("docs/operations-running.md"),
    Path("docs/operations-logs.md"),
    Path("docs/operations-publishing.md"),
    Path("docs/operations-diagnostics.md"),
    Path("docs/cookbook.md"),
    Path("docs/how-to.md"),
    Path("docs/glossary.md"),
    Path("docs/configuration.md"),
    Path("docs/configuration-runtime.md"),
    Path("docs/configuration-agents.md"),
    Path("docs/configuration-checks-git.md"),
    Path("docs/configuration-flows-supervisor.md"),
