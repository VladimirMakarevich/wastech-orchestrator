...
For a **plan-vs-implementation audit**, a claim usually asserts that shipped code diverges from — or falls short of — the plan of record. Verify *both* sides against `{repo}`:
