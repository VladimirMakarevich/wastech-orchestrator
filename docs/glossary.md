...
- **Task lifecycle folders** - `tasks/pending` holds queued tasks, `tasks/processing` holds active work, `tasks/done` and `tasks/failed` hold terminal tasks, and `.worc/tasks/rejected` is the quarantine folder for invalid tasks.
