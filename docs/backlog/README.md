...
| --- | --- | --- |
| [P5 remediation — SKIPPED / deferred items](p5-remediation-skipped-items.md) | The pieces left out of the 2026-07-08 P5 orchestrator remediation: **target-repo** work (A1 demote coverage-blocking in `wastech-mdlint` `review.md`; D1 task-authoring hygiene), an **owner live-smoke** (E1/F37 — prove Claude native-memory isolation is structural), and two **in-repo deferrals** (A3 delta-observe; C2 model/schema-400 error class). | Target-repo flows are a different repository; the owner smoke is not drivable non-interactively; the deferrals are YAGNI until measured. From the P5 remediation ([archive/done/p5-findings-remediation-plan.md](archive/done/p5-findings-remediation-plan.md), [TEST-FINDINGS.md](../../TEST-FINDINGS.md) F37/F40/F42/F50). |
