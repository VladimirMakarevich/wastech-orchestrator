...
Все четыре фазы разобраны, открытых вопросов не осталось. Полные формулировки — в [requirements-step-0.md](requirements-step-0.md) и в файлах фаз; здесь одна строка на решение, чтобы их не искать по четырём документам.
