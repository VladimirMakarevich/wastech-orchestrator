...
Status: **Шаг 0 — accepted, в работе по фазам; Шаги 1, 1b, 2, 3, 4 — proposed; advanced mode — требования сформированы, 12 открытых вопросов** Date: 2026-08-13 Owner: Vladimir Makarevich Revised: 2026-08-17 (разбор advanced mode по коду: [requirements-advanced-mode.md](requirements-advanced-mode.md))
...
| [requirements-advanced-mode.md](requirements-advanced-mode.md) | **Заключительная фаза кампании:** контракт приёмки advanced mode — определение пола через свойства, требования ТA.x, отрицательные требования, четыре блокирующих предусловия из числа найденных дефектов и **12 открытых вопросов владельцу**. Фаза не принята: сначала вопросы. |
