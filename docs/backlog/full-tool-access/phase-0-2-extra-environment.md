...
Status: **ready to implement** Date: 2026-08-13 Owner: Vladimir Makarevich Требования: Т0.2, Т0.5 и Т0.6 из [requirements-step-0.md](requirements-step-0.md) `schema_version`: +1 (36, если фаза едет первой из тех, что меняют формат) Зависимости: нет, но осмысленна после [0.1](phase-0-1-allowed-environment.md)
