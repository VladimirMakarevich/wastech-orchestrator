...
- 🔜 Continue with [05 (safety & evaluation)](plan/index.md) — the final V1 phase (drills + offline replay baseline); tune the provisional Q1/Q3/Q5 integers against that baseline.
