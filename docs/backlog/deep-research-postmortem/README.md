...
Status: **in progress — steps 1-8 implemented (P0.1, P0.3, P0.2, P1.6, P1.5, P1.4, P1.7, P1.4a); P2.8 piece 2 shipped early with P1.4; next P2.8 remainder, then P2.9, P3.10** Date: 2026-07-25 Owner: Vladimir Makarevich
